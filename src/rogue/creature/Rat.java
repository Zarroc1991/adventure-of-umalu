...
public class Rat extends Monster {
    ...
    public void fight(Player opponent) {
        ...
        switch (ran) {
            case 0:
                System.out.println("Ihre Zähne stecken in deinem Hintern.");
                break;
            case 1:
                System.out.println("Sie beißt in deinen großen Zeh");
                break;
            case 2:
                System.out.println("Tollwutalarm");
                break;
            case 3:
                System.out.println("Sie quickt so laut.");
                break;
        }
